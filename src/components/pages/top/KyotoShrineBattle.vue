<template>
  <div :class="{ 'page-kyoto--sp': isSmartPhone }" class="page-kyoto">
    ...
    <div class="page-kyoto__detail">
      ...
      <br>
      太一（プレイヤー）が荒ぶる神々によって腐敗した京都の観光地(神社等)を救う物語。太一は神々の怒りを抑えるため、4つの神社に向かい、圧倒的かつ公平的一発勝負（じゃんけん）によって神々の怒りを押さえ込む。太一は足を運んだ先の観光地（神社）でその土地の神様を倒すことで、その土地の歴史や縁の情報を手に入れることができる。
    </div>
